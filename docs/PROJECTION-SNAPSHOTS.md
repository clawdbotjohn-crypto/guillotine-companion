...
Current data state after migration 006: reconstructed decision Weeks 1–3 are retained, the too-early reconstructed Week 4 seed and its children are deleted, the Week 4 coordinate is free, and no historical `exact` row exists. Do not manufacture an exact row from an old or current live response; exact evidence begins with a successful prospective capture in the approved Tuesday window.
